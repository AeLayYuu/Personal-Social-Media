...
String uploadEndPoint =
    'http://192.168.1.114/social_media/comment/comment_image/fileUpload.php';
String imageUrl = "http://192.168.1.114/social_media/comment/comment_image/";

Future<List<Comment>> getCommentData() async {
  try {
    var url = await http.post(
        "http://192.168.1.114/social_media/comment/conn.php");
...
Future<http.Response> insertMethod() async {
  var response = await http.post(
      "http://192.168.1.114/social_media/comment/insertData.php",
      body: {
...
Future<http.Response> deleteComment(String id) async {
  ...
  print('>>>>>>>>>>>>>>>>>>>>' + id);
  var response = await http.post(
      "http://192.168.1.114/social_media/comment/deleteData.php",
      body: {'id': id});
